import 'dart:ui';
import 'package:coffe_ecom/controllers/payment_controller.dart';
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  void initState() {
    listener = () {
      ...
      if (_paymentController.errorMsg.isNotEmpty) {
        ScaffoldMessenger.of(context).hideCurrentSnackBar();
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
            _paymentController.errorMsg,
    ...
    _paymentController.addListener(listener);
    super.initState();
  }

  @override
  void dispose() {
    _paymentController.removeListener(listener);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              payment != null && address != null
                  ? Center(
                      child: FilledButton(
                        onPressed: () {
                          _paymentController.savePaymentItems(cartController.cartCoffes);
                        },
                        style: FilledButton.styleFrom(
                          backgroundColor: const Color(0xff8C4D21),
                          fixedSize: const Size(double.infinity, 50),
    ...
    return BackgroundContainer(
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: _paymentController.success
              ? BackButton(
                  onPressed: () {
                    cartController.cartCoffes = [];
                    bottomNavigationIndex = 0;
